...
test:
	go test -v -cover `go list ./... | grep -v ./tools` -coverprofile cover.out
...
.PHONY: postgres dropdb createdb migrateup migratedown migrateup1 migratedown1 sqlc test server mock testcoverage proto evans